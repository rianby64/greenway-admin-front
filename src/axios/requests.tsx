...
export const postRoute = async (approved: boolean, animals: boolean, children: boolean, disabilities: boolean, minutes: number, title: string, description: string, type: Array<String>, distance: number) => {
